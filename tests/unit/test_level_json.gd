...
func test_rejects_garbage_and_bad_shapes():
	...
	assert_null(LevelJson.parse('{"format":1,"title":"T","crates":[{"x":1,"y":2}]}'))  # no type
	assert_null(LevelJson.parse('{"format":1,"title":"T","crates":[{"x":9e9,"y":2,"type":"a"}]}'))


func test_unknown_fields_ignored():
	var l := LevelJson.parse('{"format":1,"title":"T","crates":[],"future_thing":123}')
	assert_not_null(l)
