...
[node name="Crate1" parent="." groups=["crates"] instance=ExtResource("3")]
position = Vector2(1400, 568)

[node name="Crate2" parent="." groups=["crates"] instance=ExtResource("3")]
position = Vector2(1400, 502)

[node name="Crate3" parent="." groups=["crates"] instance=ExtResource("3")]
...
> (corrected: groups is a node-header attribute in Godot 4, not a body property)
